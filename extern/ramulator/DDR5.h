...
public:
    ...
    enum class Org;
    enum class Speed;
    DDR5(Org org, Speed speed);
    DDR5(const string& org_str, const string& speed_str);
    ...
    /* Prereq */
    function<Command(DRAM<DDR5>*, Command cmd, int)> prereq[int(Level::MAX)][int(Command::MAX)];

    // SAUGATA: added function object container for row hit status
    /* Row hit */
    function<bool(DRAM<DDR5>*, Command cmd, int)> rowhit[int(Level::MAX)][int(Command::MAX)];
    function<bool(DRAM<DDR5>*, Command cmd, int)> rowopen[int(Level::MAX)][int(Command::MAX)];
    ...
    /* Lambda */
    function<void(DRAM<DDR5>*, int)> lambda[int(Level::MAX)][int(Command::MAX)];

    /* Organization */
    enum class Org : int
    {
        DDR5_2Gb_x4,   DDR5_2Gb_x8,   DDR5_2Gb_x16,
        DDR5_4Gb_x4,   DDR5_4Gb_x8,   DDR5_4Gb_x16,
    ...
    struct OrgEntry {
        ...
        {4<<10,  4, {0, 0, 4, 4, 1<<16, 1<<10}}, {4<<10,  8, {0, 0, 8, 4, 1<<14, 1<<10}}, {4<<10, 16, {0, 0, 2, 4, 1<<15, 1<<10}},
    ...
    {
        DDR5_1600K, DDR5_1600L,
        DDR5_1866M, DDR5_1866N,
        DDR5_2133P, DDR5_2133R,
        DDR5_2400R, DDR5_2400U,
        DDR5_4800,
        MAX
    };
    ...
    int prefetch_size = 16; // 16n prefetch
    ...
    struct SpeedEntry {
        ...
        int nRFC, nREFI;
        int nPD, nXP, nXPDLL; // XPDLL not found in DDR5??
        ...
        {4800,  2400      , (3/0.4)/18,8, 8,12, 2, 32, 32, 32, 24, 78, 110, 18, 6, 18, 36, 0, 0, 0, 0, 0, 12, 16, 0, 14, 0, 0}
    }, speed_entry;
