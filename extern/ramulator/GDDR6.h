...
public:
    ...
    enum class Speed : int
    {
        ...
        GDDR6_7000, GDDR6_10000,
        MAX
    };

    int prefetch_size = 16; // 16n prefetch QDR
    ...
    struct SpeedEntry {
        ...
        // {10000, 
        // 2500, int(0.66*(7/5)), 
        // 4, int(3*(7/5)*0.66), int(4*(7/5)*0.66), 
        // int(24*(7/5)*0.66), int(24*(7/5)*0.66), int(20*(7/5)*0.66), int(24*(7/5)*0.66), int(16*(7/5)*0.66), 
        // int(54*(7/5)*0.66), int(77*(7/5)*0.66), 
        // int(2*(7/5)*0.66), int(3*(7/5)*0.66), int(7*(7/5)*0.66), int(16*(7/5)*0.66), 
        // int(9*(7/5)*0.66), int(32*(7/5)*0.66), int(420*(7/5)*0.66), 
        // 0, 0, 
        // int(10*(7/5)*0.66), int(10*(7/5)*0.66), 0, 
        // 0, 0, 0}        
        {10000, 
        2500, 2/5, 
        4, 3, 4, 
        int(24*(7/5)), int(24*(7/5)), int(20*(7/5)), int(24*(7/5)), int(16*(7/5)), 
        int(54*(7/5)), int(77*(7/5)), 
        int(2*(7/5)), int(3*(7/5)), int(7*(7/5)), int(16*(7/5)), 
        int(9*(7/5)), int(32*(7/5)), int(420*(7/5)), 
        0, 0, 
        int(10*(7/5)), int(10*(7/5)), 0, 
        0, 0, 0}
    }, speed_entry;
