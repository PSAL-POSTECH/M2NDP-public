...
public:
    ...
    bool is_scm_row_open(list<Request>::iterator req) { return false; }
    bool is_dram_row_open(list<Request>::iterator req) { return false; }
    bool is_scm_row_hit(list<Request>::iterator req) { return false; }
    bool is_dram_row_hit(list<Request>::iterator req) { return false; }
